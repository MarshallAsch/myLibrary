...
static void testStrSearch_offset()
{
	...
	if (strSearchOffset("This is a test string. a is long one....", NULL, 0) != -1)
	{
		printf("FAILED 56: NULL needle\n");
	}

	if (strSearchOffset("This is a test string. a is long one....", "is", 9) != 25)
	{
		printf("FAILED 57: match 3rd\n");
	}

	if (strSearchOffset("This is a test string. a is long one....", "not", 0) != -1)
	{
	...
	if (strSearchOffset("This is a test string. a is long one....", "a", -1) != -1)
	{
		printf("FAILED 60: offset tooo low\n");
	}

	if (strSearchOffset("This is a test string. a is long one....", "a", 50) != -1)
	{
